      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2 font-semibold">
            ...
            <span className="text-xl">MyStore</span>
          </div>
            ...
            <div className="grid gap-10 lg:grid-cols-2 lg:gap-12">
              <div className="space-y-6 md:space-y-8">
                <div className="inline-flex items-center rounded-full border border-primary/20 bg-primary/10 px-3 py-1 text-sm font-medium text-primary">
                  <span className="mr-1">✨</span> Streamline Your Business
                  Operations
                </div>
                ...
                <p className="max-w-[600px] text-lg text-muted-foreground md:text-xl">
                  Our all-in-one dashboard provides powerful tools to track
                  customers, manage products, and handle invoices in one
          ...
          <div className="container px-4 md:px-6">
            <div className="mx-auto mb-16 max-w-2xl text-center">
              ...
              <p className="text-muted-foreground md:text-lg">
                Our comprehensive suite of tools helps you manage every aspect
                of your business.
              </p>
            </div>
        ...
        <section className="bg-muted py-20 md:py-32">
          <div className="container px-4 md:px-6">
            <div className="mx-auto mb-16 max-w-2xl text-center">
              ...
              <p className="text-muted-foreground md:text-lg">
                See what our customers have to say about our business management
                platform.
              </p>
            </div>
              ...
              <div className="flex flex-col justify-center gap-4 sm:flex-row">
                ...
                <Link href="/login">
                  <Button
                    size="lg"
                    variant="outline"
                    className="w-full border-primary-foreground/20 text-base text-primary hover:bg-primary-foreground/10 sm:w-auto"
                  >
                    Schedule a Demo
                  </Button>
                </Link>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Streamlining business operations since 2020. Our mission is to
